...
def validate():
    ...
    real_path = os.path.join(script_dir, "..", "..", "..", "lakes", "inputs_promoted", "L_compton_electrons_promoted.jsonl")
    scramble_path = os.path.join(script_dir, "..", "..", "..", "lakes", "inputs_promoted", "L_compton_scramble_ctrl_promoted.jsonl")
    if validate_lake(real_path, "electron_compton_kinematic") and validate_lake(scramble_path, "electron_compton_scramble_ctrl"):
        print("\n[SUCCESS] READY FOR ENGINE.")
