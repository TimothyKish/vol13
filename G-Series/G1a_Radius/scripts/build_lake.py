...
# PURPOSE: Sovereign builder for g1a_radius.
#          Queries the SDSS CasJobs/SkyServer API for Petrosian Radii.
# ==============================================================================
...
LAKE_ID = "g1a_radius"
SDSS_SQL = "SELECT TOP 100000 objID, petroRad_r FROM Galaxy WITH(NOLOCK) WHERE clean=1 AND petroRad_r > 0"
...
def build_raw_lake():
    ...
    try:
        print("Executing SDSS SQL Query...")
