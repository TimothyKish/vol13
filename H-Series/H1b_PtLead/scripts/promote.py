...
RAW_PATH = SCRIPT_DIR.parent / "lake" / "h1b_raw.jsonl"
PROMOTED_PATH = SCRIPT_DIR.parents[2] / "lakes" / "inputs_promoted" / "h1b_pt_lead_promoted.jsonl"

def promote():
    print("=" * 60 + "\n H1b PT-LEAD PROMOTION SCRIPT \n" + "=" * 60)
    count = 0
            ...
            if raw_val:
                try:
                    ...
                    promoted_rec = {
                        ...
                        "domain": "subnuclear_pt_lead", "volume": 11, "lake_id": "h1b_pt_lead",
                        "muon1_pt_gev": clean_val,
