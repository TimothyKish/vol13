...
RAW_PATH = SCRIPT_DIR.parent / "lake" / "h1c_raw.jsonl"
PROMOTED_PATH = SCRIPT_DIR.parents[2] / "lakes" / "inputs_promoted" / "h1c_pt_sublead_promoted.jsonl"

def promote():
    print("=" * 60 + "\n H1c PT-SUBLEAD PROMOTION SCRIPT \n" + "=" * 60)
    count = 0
            ...
            if raw_val:
                try:
                    ...
                    promoted_rec = {
                        ...
                        "domain": "subnuclear_pt_sublead", "volume": 11, "lake_id": "h1c_pt_sublead",
                        "muon2_pt_gev": clean_val,
