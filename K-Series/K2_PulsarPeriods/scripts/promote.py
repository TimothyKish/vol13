# ==============================================================================
# SCRIPT: promote.py
# PURPOSE: Maps raw K2 Pulsar Period data to the KishLattice schema.
# ==============================================================================
import json
import uuid
...
def promote():
    ...
    with RAW_PATH.open("r", encoding="utf-8") as fin, PROMOTED_PATH.open("w", encoding="utf-8") as fout:
        for line in fin:
            ...
            raw_val = raw_rec.get("P0")
            if raw_val and str(raw_val).strip() not in ("", "*"):
                try:
                    # ATNF default is seconds. Convert to ms.
                    ...
                    promoted_rec = {
                        ...
                        "meta": {"source": "ATNF Pulsar Catalog", "ingest_timestamp": now_ts, "sovereign": True},
