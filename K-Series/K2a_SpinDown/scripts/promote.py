...
RAW_PATH = SCRIPT_DIR.parent / "lake" / "k2a_raw.jsonl"
PROMOTED_PATH = SCRIPT_DIR.parents[2] / "lakes" / "inputs_promoted" / "k2a_spindown_promoted.jsonl"

def promote():
    print("=" * 60 + "\n K2A SPINDOWN PROMOTION SCRIPT \n" + "=" * 60)
    count = 0
            ...
            if raw_val:
                try:
                    ...
                    promoted_rec = {
                        ...
                        "domain": "stellar_spindown", "volume": 11, "lake_id": "k2a_spindown",
                        "spin_down_rate": clean_val,
