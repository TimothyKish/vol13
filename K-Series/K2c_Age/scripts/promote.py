...
RAW_PATH = SCRIPT_DIR.parent / "lake" / "k2c_raw.jsonl"
PROMOTED_PATH = SCRIPT_DIR.parents[2] / "lakes" / "inputs_promoted" / "k2c_age_promoted.jsonl"

def promote():
    print("=" * 60 + "\n K2C AGE PROMOTION SCRIPT \n" + "=" * 60)
    count = 0
            ...
            if raw_val:
                try:
                    ...
                    promoted_rec = {
                        ...
                        "domain": "stellar_age", "volume": 11, "lake_id": "k2c_age",
                        "characteristic_age_yr": clean_val,
