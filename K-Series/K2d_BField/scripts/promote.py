...
RAW_PATH = SCRIPT_DIR.parent / "lake" / "k2d_raw.jsonl"
PROMOTED_PATH = SCRIPT_DIR.parents[2] / "lakes" / "inputs_promoted" / "k2d_bfield_promoted.jsonl"

def promote():
    print("=" * 60 + "\n K2D B-FIELD PROMOTION SCRIPT \n" + "=" * 60)
    count = 0
            ...
            if raw_val:
                try:
                    ...
                    promoted_rec = {
                        ...
                        "domain": "stellar_bfield", "volume": 11, "lake_id": "k2d_bfield",
                        "surface_b_field_gauss": clean_val,
