# ==============================================================================
# SCRIPT: promote.py (M Materials Wrongbox)
# PURPOSE: Applies the WRONG dimensionality to the Materials Project lake.
# ==============================================================================
import json
import uuid
...
DOMAIN = "materials_wrongbox"
LAKE_ID = "mat_wrongbox"
REQUIRED_FIELD = "volume"

SCRIPT_DIR = Path(__file__).resolve().parent
RAW_PATH = SCRIPT_DIR.parent / "lake" / "mat_wrongbox_raw.jsonl"
...
def promote():
    ...
    with RAW_PATH.open("r", encoding="utf-8") as fin, PROMOTED_PATH.open("w", encoding="utf-8") as fout:
        for line in fin:
            ...
            raw_val = data_source.get(REQUIRED_FIELD)
            ...
            if raw_val is not None and str(raw_val).strip() != "":
                try:
                    ...
                    promoted_rec = {
                        ...
                        "volume": 11,
                        "lake_id": LAKE_ID,
                        REQUIRED_FIELD: clean_val, 
                        "geometry_payload": {"coordinates": [], "dimensionality": 3, "geometry_type": "scalar"},
                        "meta": {"source": "Materials Project (FALSIFICATION RUN)", "ingest_timestamp": now_ts, "sovereign": True},
