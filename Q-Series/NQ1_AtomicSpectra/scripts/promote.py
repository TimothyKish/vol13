# ==============================================================================
# SCRIPT: promote.py
# PURPOSE: Maps synthetic NQ1 spectra to the KishLattice sovereign schema.
# ==============================================================================
import json, uuid
...
def promote():
    ...
    with RAW_PATH.open("r", encoding="utf-8") as fin, PROMOTED_PATH.open("w", encoding="utf-8") as fout:
        for line in fin:
            ...
            promoted = {
                ...
                TARGET_FIELD: rec["wavelength_nm"], 
    ...
    print(f"SUCCESS: {count:,} synthetic spectra promoted.")
