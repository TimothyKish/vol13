"""
build_lake.py -- T2b_Atlantic FIXED
NOAA CO-OPS station 8638610, Sewells Point VA
...
RAW_PATH = os.path.join(os.path.dirname(__file__), "..", "lake", "t2b_atlantic_raw.jsonl")
os.makedirs(os.path.dirname(RAW_PATH), exist_ok=True)

STATION_ID = "8638610"
STATION_NAME = "Sewells Point VA"
OCEAN_BASIN = "Atlantic"
DOMAIN = "planetary_atlantic"
LAKE_ID = "t2b_atlantic"
...
def build():
    print(f"[T2b_Atlantic] Fetching NOAA {STATION_ID} ({STATION_NAME})")
