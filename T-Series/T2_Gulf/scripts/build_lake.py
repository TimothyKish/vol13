"""
build_lake.py -- T2c_Gulf FIXED
NOAA CO-OPS station 8771341, Galveston TX
...
STATION_ID = "8771341"
STATION_NAME = "Galveston TX"
OCEAN_BASIN = "Gulf"
DOMAIN = "planetary_gulf"
LAKE_ID = "t2c_gulf"
...
def build():
    print(f"[T2c_Gulf] Fetching NOAA {STATION_ID} ({STATION_NAME})")
    print(f"  monthly chunks | hourly_height | {START_YEAR}-{END_YEAR}")
    print(f"  NOTE: Gulf of Mexico is diurnal (once/day) — intervals ~24hrs expected")
    all_wl = []
    failed = 0
