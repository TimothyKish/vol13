# ==============================================================================
# SCRIPT: build_lake.py (U1_USGS_san_andreas)
# TARGET: Pull M>=5.0 events from 1973 to 2025 for the San Andreas Fault.
...
FAULT_NAME = "u1_usgs_san_andreas"

# Relative pathing: resolves to U-Series/U1_USGS_san_andreas/lake/
...
def build():
    ...
    params = {
        ...
        "endtime": "2025-01-01",
        "minlatitude": 32.0, "maxlatitude": 37.5,
        "minlongitude": -122.0, "maxlongitude": -114.0,
        "orderby": "time-asc", 
        "limit": 20000 
    }
