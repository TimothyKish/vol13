# ==============================================================================
# SCRIPT: promote.py (U1_USGS_san_andreas)
...
LAKE_ID = "u1_usgs_san_andreas"
DOMAIN  = "seismic_temporal"
SOURCE  = "USGS Earthquake Hazards Program FDSNWS — San Andreas fault M>=5.0 depth 0-50km"
VOL     = 10
...
def promote():
    ...
    with RAW_PATH.open("r", encoding="utf-8") as f_in, \
        ...
        for line_num, line in enumerate(f_in, 1):
            ...
            # Positive definite guard — intervals must be > 0
