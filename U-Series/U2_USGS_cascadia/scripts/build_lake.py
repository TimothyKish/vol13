# ==============================================================================
# SCRIPT: build_lake.py (U2_USGS_cascadia)
# TARGET: Pull M>=5.0 events from 1973 to 2025 for Cascadia Subduction Zone.
...
def build():
    ...
    params = {
        ...
        "minlongitude": -130.0, "maxlongitude": -121.0,
        "orderby": "time-asc", 
        "limit": 20000 
    }
