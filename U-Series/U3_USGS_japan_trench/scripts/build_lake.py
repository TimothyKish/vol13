# ==============================================================================
# SCRIPT: build_lake.py (U3_USGS_japan_trench)
# TARGET: Pull M>=5.0 events from 1973 to 2025 for the Japan Trench.
...
FAULT_NAME = "u3_usgs_japan_trench"
...
def build():
    ...
    params = {
        ...
        "minlongitude": 138.0, "maxlongitude": 147.0,
        "orderby": "time-asc", 
        "limit": 20000 
    }
